...
- Changed the color of the whisper icon to blue (so it's easier to distinguish between instant-buyout and in-person trade listings when price-checking an item)
